...
test = [allCapacityUsed == 0, testF noCapacityError, connectedCities, not notConnectedCities, alreadyConnectedCities == finalRegion, testF notAddedCity, delayTunc3c5 == 10.5]
